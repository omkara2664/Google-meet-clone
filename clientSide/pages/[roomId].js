...
const Room = () => {
    ...
    const { players, setPlayers, playerHighlighted, nonHighlightedPlayers, toggleAudio, toggleVideo, leaveRoom } = usePlayer(myId, roomId, peer, stream);  // Why I passing the myId because I want to same myId in the players object if there I will call peerHook then it will return new peer id.  But we are using the older one
